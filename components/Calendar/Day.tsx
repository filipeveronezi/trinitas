...
export function Day(props: DayProps) {
  return (
    <div className="flex cursor-default flex-col items-center justify-center rounded-3xl border-4 border-black bg-black font-bold lg:hover:translate-y-[-8px] lg:hover:translate-x-[-8px] lg:hover:drop-shadow-[8px_8px_0_rgba(32,32,32,1)]">
